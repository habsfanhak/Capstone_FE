...
export async function addComment(title, comment, date, email, fullName, time) {

  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/addComment`, {
    method: 'POST',
    body: JSON.stringify({ title, comment, date, email, fullName, time }),
    headers: {
      'content-type': 'application/json',
    },
  });
...
export async function updateComment(comment, newComment, date, time){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/updateComment`, {
    method: 'POST',
    body: JSON.stringify({ comment, newComment, date, time }),
    headers: {
      'content-type': 'application/json',
    },
  });
...
export async function replyingComment(comment){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/addingReply`, {
    method: 'POST',
    body: JSON.stringify({comment}),
    headers: {
      'content-type': 'application/json',
...
export async function getReplies(){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/getReplies`, {
    method: 'GET',
    headers: {
      'content-type': 'application/json',
    },
...
export async function commentReplied(comment){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/commentReplied`, {
    method: 'POST',
    body: JSON.stringify({comment}),
    headers: {
      'content-type': 'application/json',
...
export async function addReply(commentID, email, fullName, reply){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/addReply`, {
    method: 'POST',
    body: JSON.stringify({commentID, email, fullName, reply}),
    headers: {
      'content-type': 'application/json',
    },
  });
...
export async function replyAdded(comment){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/replyAdded`, {
    method: 'POST',
    body: JSON.stringify({comment}),
    headers: {
      'content-type': 'application/json',
...
export async function cancelReply(comment){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/cancelReply`, {
    method: 'POST',
    body: JSON.stringify({comment}),
    headers: {
      'content-type': 'application/json',
...
export async function toUpdateReply(replyID){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/toUpdateReply`, {
    method: 'POST',
...
export async function updateReply(replyID, newReply){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/updateReply`, {
    method: 'POST',
    body: JSON.stringify({replyID, newReply}),
    headers: {
      'content-type': 'application/json',
    },
  });
...
export async function deleteReplies(commentID){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/deleteReplies`, {
    method: 'POST',
...
export async function deleteReply(replyID){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/deleteReply`, {
    method: 'POST',
    body: JSON.stringify({replyID}),
    headers: {
      'content-type': 'application/json',
...
export async function removeFromCart(email, model){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/removeFromCart`, {
    method: 'POST',
    body: JSON.stringify({ email, model }),
    headers: {
      'content-type': 'application/json',
...
export async function purchaseWithCard(items, price, token){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/purchaseWithCard`, {
    method: 'POST',
    body: JSON.stringify({ items, price, token }),
    headers: {
      'content-type': 'application/json',
    },
  });
...
export async function deleteCart(email){
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/deleteCart`, {
    method: 'POST',
    body: JSON.stringify({ email }),
    headers: {
      'content-type': 'application/json',
